...
function createAdjustedText (alignmentType, editor)
{
    ...
    for (; currentRow <= selectionRange.end.row; currentRow++)
    {
        ...
        // spacing), skip.
        if (lineIsAcceptableToMove (editor, currentRowString))
        {
...
function lineIsAcceptableToMove (editor, currentRowString)
{
